...
<html>
	...
	<body>
		<div class="fixed search-overlay container-fluid primary vw-100 vh-100 text-white popup" data-popup="search-overlay">
			<div class="container">
				<div class="row">
		...
		<div id="mobile-menu" class="fixed vh-100 w-100 primary text-white container-fluid d-lg-none">
			<div class="row text-right p-2 pt-4 p-sm-4">
				<div class="col-12">
					<i id="mobile-menu-close" class="material-icons hover">close</i>
				</div>
		...
		<nav id="navbar" class="fixed white drop-shadow <?php if ($currentPage == "home"){?>bg-on-scroll bg-transparent<?php } ?>">
			<div class="container text-primary">
				<div class="row justify-content-between align-items-center nav-bar">
					...
					<div class="col-auto d-none d-lg-flex align-items-center">
						<ul>
							<li class="mr-sm-1 mr-md-4 <?php if ($currentPage == "home"){?>active-page<?php } ?>"><a class="hover" href="./">Home</a></li>
							<li class="mr-sm-1 mr-md-4 <?php if ($currentPage == "about"){?>active-page<?php } ?>"><a class="hover" href="about.php">About</a></li>
							<li class="form-scroll <?php if ($currentPage == "contact"){?>active-page<?php } ?>"><a class="hover" href="contact.php">Contact</a></li>
						</ul>
